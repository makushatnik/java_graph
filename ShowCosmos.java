...
public class ShowCosmos extends JApplet {
	...
	protected void drawFrame(Graphics g) {
		...
		for (int i = 0; i < planets.length; i++)
		{
			...
			int newX = (int)(centerX + Math.cos(planets[i].getAngle())*planets[i].getRadiusOrbit());
			int newY = (int)(centerY - Math.sin(planets[i].getAngle())*planets[i].getRadiusOrbit());
	...
	public void init() {
		...
		centerX = (int)(scrWidth / 2);
		centerY = (int)(scrHeight / 2);
		frm = new JPanel() {
